...
function renderLanguages() {
    ...
    // Bayraklar iÃ§in hover efektlerini ekle
...
function setupContactForm() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                throw new Error('Beklenmeyen yanÄ±t: ' + response.status);
            }
        } catch (error) {
    ...
    // Form inputlarÄ±na animasyon ekle
...
function init3DCards() {
    ...
    cards.forEach(card => {
        ...
        card.addEventListener('mousemove', (e) => {
            ...
            // Paralaks efekti iÃ§in iÃ§erik Ã¶ÄŸelerini hareket ettir
...
function startParticleEffect() {
    ...
    function animate() {
        ...
        for (let i = 0; i < particles.length; i++) {
            ...
            // ParÃ§acÄ±klar arasÄ± baÄŸlantÄ±lar
